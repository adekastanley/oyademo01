					...
					<div className="relative pt-24 md:pt-36">
						...
						<div className="mx-auto max-w-7xl px-6">
							<div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
								...
								>
									Your Trusted Partner in Motion.
								</TextEffect>
								<TextEffect
									per="line"
									preset="fade-in-blur"
								...
								>
									Reliable logistics, seamless delivery. We move your goods with
									precision, speed, and care—across town or across borders.
								</TextEffect>
								...
								>
									...
									>
										...
										>
											<Link href="#link">
												<span className="text-nowrap">Download the app</span>
											</Link>
										</Button>
									</div>
									<Button
